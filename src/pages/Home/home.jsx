      ...
      <Container maxWidth="sm" sx={{ bgcolor: '#131319', color: 'white', padding: '20px', minHeight: '100vh', minWidth: '750px' }}>
        ...
        <Box sx={{ bgcolor: '#27292d', mb: 1, mt: 2, padding: '25px 20px', borderRadius: '12px', border: '2px solid #35373b' }}>
          ...
          <Box sx={{ display: 'flex', width: '100%', justifyContent: 'center', position: 'relative' }}>
                <IconButton sx={{color: '#fff', borderRadius: '50%', width: '50px', height: '50px', position: 'absolute', top: '12%', left: '2%', backgroundColor: '#27292d', '&:hover': {backgroundColor: "#27292d"}, mr: 2}}>
                    <Typography component="span" align='left' variant="body2" sx={{ fontSize: '18px',}}>💬</Typography>
                </IconButton>
            <input
              type="text"
              ...
              <CardContent sx={{ padding: '0 !important' }}>
                <Box alignItems="flex-start" sx={{ display: 'flex', alignItems: 'flex-start', flexDirection: 'column' }}>
                  ...
                  <Box sx={{display: 'flex', flexDirection: 'column' }}>
                        <Box sx={{ display: 'flex', alignItems: 'flex-start', mt: 1, backgroundColor: '#191920', padding: '20px 15px', borderRadius: '8px' }}>
                          <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                            <IconButton sx={{color: '#fff', borderRadius: '50%', width: '50px', height: '50px',  backgroundColor: '#27292d', '&:hover': {backgroundColor: "#27292d"}, mr: 2}}>
                                <Typography component="span" align='left' variant="body2" sx={{ fontSize: '18px',}}>{post.emoji}</Typography>
                            </IconButton>
                          </Box>
        ...
        <HomePageModal open={open} handleClose={handleClose} showRegister={showRegister} handleShowLogin={handleShowLogin} handleShowRegister={handleShowRegister} />
      </Container>
    </Box>
  );
}

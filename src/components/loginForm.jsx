      ...
      <Container sx={{ px: '0 !important' }}>
        <Box sx={{ width: '100%', bgcolor: '#27292d', borderRadius: '8px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Box sx={{ width: '100%', mt: 2 }}>
            <label htmlFor="email" style={{ display: 'flex', color: 'white', fontSize: '14px', letterSpacing: '0.75px' }}>Email or Username</label>
            <input
              type="text"
              id="email"
          ...
          <Box sx={{ width: '100%', mt: 0, position: 'relative' }}>
            <Box sx={{ display: 'flex', width: '100%', mt: 2, flexDirection: 'row', justifyContent: 'space-between' }}>

    ...
    <Box sx={{ bgcolor: '#27292d', color: 'white', padding: '40px 30px', borderRadius: '8px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', minWidth: '400px', border: '2px solid grey' }}>
      <Container sx={{ px: '0 !important' }}>
        <Box sx={{ width: '100%', bgcolor: '#27292d', borderRadius: '8px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <Typography variant="text" align="center" gutterBottom sx={{ fontWeight: 'bold', fontSize: "18px" }}>
            Create an account to continue
          </Typography>
          <br />
          <Box sx={{ width: '100%', mt: 2 }}>
            <label htmlFor="email" style={{ display: 'flex', color: 'white', fontSize: '14px', letterSpacing: '0.75px' }}>Email</label>
            <input
              type="text"
              id="email"
          ...
          <Box sx={{ width: '100%', mt: 2 }}>
            <label htmlFor="email" style={{ display: 'flex', color: 'white', fontSize: '14px', letterSpacing: '0.75px' }}>Username</label>
            <input
              type="text"
              id="username"
          ...
          <Box sx={{ width: '100%', mt: 0, position: 'relative' }}>
            ...
            <label htmlFor="password" style={{ display: 'block', color: 'white', fontSize: '14px', letterSpacing: '0.75px' }}>Password</label>
          </Box>
            <input
            ...
            <IconButton
              ...
              edge="end"
              sx={{ position: 'absolute', right: '10px', top: '74%', transform: 'translateY(-50%)', color: 'white' }}
            >
